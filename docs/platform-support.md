...
| wasm npm | `wasm32-unknown-unknown` / Node 22+ ESM | `ubuntu-latest` | 1 — compile and package verified | default and `--features dialects-full`; seven Node/browser package smokes in the release workflow | `platform.yml` + `release-npm.yml` |
