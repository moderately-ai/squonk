...
import { initSync } from "../pkg-postgres/squonk_wasm.js";
import * as wasm from "../pkg-postgres/squonk_wasm.js";
import { createNodeSquonk } from "./node.js";

const api = createNodeSquonk(initSync, wasm, new URL("../pkg-postgres/squonk_wasm_bg.wasm", import.meta.url), {
  defaultDialect: "postgres",
  supportedDialects: ["ansi", "postgres"] as const,
});
