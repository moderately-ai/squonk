...
import { initSync } from "../pkg-sqlite/squonk_wasm.js";
import * as wasm from "../pkg-sqlite/squonk_wasm.js";
import { createNodeSquonk } from "./node.js";

const api = createNodeSquonk(initSync, wasm, new URL("../pkg-sqlite/squonk_wasm_bg.wasm", import.meta.url), {
  defaultDialect: "sqlite", supportedDialects: ["ansi", "sqlite"] as const,
});
