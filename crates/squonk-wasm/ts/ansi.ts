...
import { initSync } from "../pkg-ansi/squonk_wasm.js";
import * as wasm from "../pkg-ansi/squonk_wasm.js";
import { createNodeSquonk } from "./node.js";

const api = createNodeSquonk(initSync, wasm, new URL("../pkg-ansi/squonk_wasm_bg.wasm", import.meta.url), {
  defaultDialect: "ansi", supportedDialects: ["ansi"] as const,
});
