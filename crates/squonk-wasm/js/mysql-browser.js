...
export const createSquonk = createBrowserSquonk(initWasm, wasm, new URL("../pkg-mysql/squonk_wasm_bg.wasm", import.meta.url), { defaultDialect: "mysql", supportedDialects: ["ansi", "mysql"] });
