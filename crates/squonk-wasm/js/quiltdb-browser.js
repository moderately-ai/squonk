...
export const createSquonk = createBrowserSquonk(initWasm, wasm, new URL("../pkg-quiltdb/squonk_wasm_bg.wasm", import.meta.url), { defaultDialect: "quiltdb", supportedDialects: ["ansi", "quiltdb"] });
