...
export const createSquonk = createBrowserSquonk(initWasm, wasm, new URL("../pkg-lenient/squonk_wasm_bg.wasm", import.meta.url), { defaultDialect: "lenient", supportedDialects: ["ansi", "lenient"] });
