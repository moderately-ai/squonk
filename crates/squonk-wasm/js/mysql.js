...
import { initSync } from "../pkg-mysql/squonk_wasm.js";
import * as wasm from "../pkg-mysql/squonk_wasm.js";
import { createNodeSquonk } from "./node.js";
const api = createNodeSquonk(initSync, wasm, new URL("../pkg-mysql/squonk_wasm_bg.wasm", import.meta.url), {
    defaultDialect: "mysql", supportedDialects: ["ansi", "mysql"],
});
