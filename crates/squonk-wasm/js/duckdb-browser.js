...
export const createSquonk = createBrowserSquonk(initWasm, wasm, new URL("../pkg-duckdb/squonk_wasm_bg.wasm", import.meta.url), { defaultDialect: "duckdb", supportedDialects: ["ansi", "duckdb"] });
