...
toggleable_features! {
    ...
    (START_TRANSACTION, "start_transaction", UtilitySyntax, utility_syntax, UtilitySyntax, start_transaction),
    (START_TRANSACTION_BLOCK_OPTIONAL, "start_transaction_block_optional", UtilitySyntax, utility_syntax, UtilitySyntax, start_transaction_block_optional),
    (TRANSACTION_WORK_KEYWORD, "transaction_work_keyword", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_work_keyword),
    (BEGIN_TRANSACTION_KEYWORD, "begin_transaction_keyword", UtilitySyntax, utility_syntax, UtilitySyntax, begin_transaction_keyword),
    (COMMIT_TRANSACTION_KEYWORD, "commit_transaction_keyword", UtilitySyntax, utility_syntax, UtilitySyntax, commit_transaction_keyword),
    (ROLLBACK_TRANSACTION_KEYWORD, "rollback_transaction_keyword", UtilitySyntax, utility_syntax, UtilitySyntax, rollback_transaction_keyword),
    (BEGIN_TRANSACTION_MODES, "begin_transaction_modes", UtilitySyntax, utility_syntax, UtilitySyntax, begin_transaction_modes),
    (TRANSACTION_SAVEPOINTS, "transaction_savepoints", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_savepoints),
    (SET_TRANSACTION, "set_transaction", UtilitySyntax, utility_syntax, UtilitySyntax, set_transaction),
    (TRANSACTION_ISOLATION_MODE, "transaction_isolation_mode", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_isolation_mode),
    (TRANSACTION_ACCESS_MODE, "transaction_access_mode", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_access_mode),
    (TRANSACTION_DEFERRABLE_MODE, "transaction_deferrable_mode", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_deferrable_mode),
    (START_TRANSACTION_ISOLATION_MODE, "start_transaction_isolation_mode", UtilitySyntax, utility_syntax, UtilitySyntax, start_transaction_isolation_mode),
    (START_TRANSACTION_DEFERRABLE_MODE, "start_transaction_deferrable_mode", UtilitySyntax, utility_syntax, UtilitySyntax, start_transaction_deferrable_mode),
    (START_TRANSACTION_CONSISTENT_SNAPSHOT, "start_transaction_consistent_snapshot", UtilitySyntax, utility_syntax, UtilitySyntax, start_transaction_consistent_snapshot),
    (TRANSACTION_MULTIPLE_MODES, "transaction_multiple_modes", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_multiple_modes),
    (TRANSACTION_MODE_COMMA_REQUIRED, "transaction_mode_comma_required", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_mode_comma_required),
    (TRANSACTION_MODES_UNIQUE, "transaction_modes_unique", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_modes_unique),
    (ABORT_TRANSACTION_ALIAS, "abort_transaction_alias", UtilitySyntax, utility_syntax, UtilitySyntax, abort_transaction_alias),
    (END_TRANSACTION_ALIAS, "end_transaction_alias", UtilitySyntax, utility_syntax, UtilitySyntax, end_transaction_alias),
    (TRANSACTION_RELEASE, "transaction_release", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_release),
    (TRANSACTION_CHAIN, "transaction_chain", UtilitySyntax, utility_syntax, UtilitySyntax, transaction_chain),
    (RELEASE_SAVEPOINT_KEYWORD_OPTIONAL, "release_savepoint_keyword_optional", UtilitySyntax, utility_syntax, UtilitySyntax, release_savepoint_keyword_optional),
...
const LABELED_CASES: &[LabeledCase] = &[
    ...
    LabeledCase {
        ...
        expect: Expect::Reject,
        required: &[&TRANSACTION_MODE_COMMA_REQUIRED],
        forbidden: &[],
    },
    LabeledCase {
        sql: "SET TRANSACTION READ ONLY, READ WRITE",
        expect: Expect::Reject,
        required: &[&TRANSACTION_MODES_UNIQUE],
        forbidden: &[],
    },
    LabeledCase {
...
mod tests {
    ...
    fn feature_subflags_are_explicitly_enumerated() {
        ...
        let UtilitySyntax {
            ...
            transaction_mode_comma_required: _,
            transaction_modes_unique: _,
